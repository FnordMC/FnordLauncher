...
Application::Application(int& argc, char** argv) : QApplication(argc, argv)
{
    ...
    // check update locks
    {
        auto update_log_path = FS::PathCombine(m_dataPath, "logs", "fnordlauncher_update.log");
        ...
        if (update_lock.exists()) {
            ...
            auto infoMsg = tr("This installation has a update lock file present at: %1\n"
                              ...
                              "proceeding.\n"
                              "Check the Fnord Launcher updater log at: \n"
                              "%7\n"
    ...
    }
    {
        ...
        if (shouldFetch && !(capabilities() & Capability::SupportsFlame)) {
            ...
            msgBox.setInformativeText(
                tr("Using the official CurseForge app's API key may break CurseForge's terms of service but should allow Fnord Launcher "
